...
2) 0,0 are X,Y co-orginates on a grid of 10,10
...
6) The rover receives a char array of commands e.g. RMMLM and returns the finishing point after the moves e.g.g 2:1:N
